package com.hufs.hw7_2_xmlparsing;
...
public class MainActivity extends AppCompatActivity {
    ...
    private class GetXMLTask extends AsyncTask<String, Void, Document> {
        ...
        public GetXMLTask(MainActivity context) {
        ...
        protected void onPostExecute(Document doc) {
            ...
            for (int i = 0; i < nodeList.getLength(); i++) {
                ...
                NodeList nameList = fstElement.getElementsByTagName("temp");
                Element nameElement = (Element) nameList.item(0);
                nameList = nameElement.getChildNodes();
                s += "온도 = " + ((Node) nameList.item(0)).getNodeValue() + " ,";
                NodeList websiteList = fstElement.getElementsByTagName("wfKor");
